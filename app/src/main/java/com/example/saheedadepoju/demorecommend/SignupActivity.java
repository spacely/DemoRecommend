...
/**
 * Created by saheedadepoju on 1/14/17.
 */
        ...
        new android.os.Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        ...
                        val = db.saveUser(user);
                        if(val.equals("Sucessfully Registered")) {
                            //Toast.makeText(getBaseContext(), db.saveUser(user), Toast.LENGTH_LONG).show();
                            onSignupSuccess();
                        }else if(val.equals("Username Exists")) {
                            onSignupFailed();
